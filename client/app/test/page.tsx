    ...
    const CodeBlock: Components["code"] = ({ className, children, ...rest }) => {
        ...
        return (
            <div className="relative group">
                ...
                <div className="absolute -right-3 top-0 hidden rounded-md border bg-background shadow-sm backdrop-blur-sm group-hover:flex">
                    <Button
                        size="icon-sm"
                        variant="secondary"
            ...
            <div className="flex flex-1 flex-col gap-4 overflow-y-auto py-4 pb-48">
                {messages.map((msg) => (
                    <div key={msg.id} className="group relative border">
                        <div className="markdown-body max-h-300 overflow-auto p-3 pb-8">
                            <ReactMarkdown
